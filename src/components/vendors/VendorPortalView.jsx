...
import VendorTaskDetail from "./VendorTaskDetail";
import VendorAuditProgress from "./VendorAuditProgress";

export default function VendorPortalView({ userEmail }) {
  ...
  const { data: audits = [] } = useQuery({
    queryKey: ['vendor-audits-for-tasks', userEmail],
    queryFn: async () => {
